	...
	with open(output, 'w') as outfile:
		...
		if qres:
			for s, p, o in qres:
				...
				print('# subject:\t', s) # prints to screen
				print('# predicate:\t', p)
				print('# object:\t', o, '\n')
				
				outfile.write('# subject:\t' + str(s) + '\n') # prints to file
				outfile.write('# predicate:\t' + str(p) + '\n')
				outfile.write('# object:\t' + str(o) + '\n\n')
				
			print('\n# end of query results, ' + str(returned) + ' returned ..\n')
			outfile.write('\n# end of query results, ' + str(returned) + ' returned ..\n')
			...
			outfile.write("# no results were returned .. ") # I'm not sure if qres can be empty, but just in case ..
